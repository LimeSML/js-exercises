...
describe("sortJapanese", () => {
  ...
  it("should throw an error if input is not an array", () => {
    expect(() => sortJapanese("not an array")).toThrow(
  ...
  it("should throw an error if any element is not a string", () => {
    expect(() => sortJapanese(["a", 1, "b"])).toThrow(
      "all elements in the array must be strings",
    );
    expect(() => sortJapanese([{}, "a"])).toThrow(
      "all elements in the array must be strings",
    );
  });
});
...
describe("toJapaneseDateString", () => {
  ...
  it("should throw an error if input is not a Date object", () => {
    expect(() => toJapaneseDateString("2025-08-01")).toThrow(
      "input must be a Date object",
    );
    expect(() => toJapaneseDateString(null)).toThrow(
      "input must be a Date object",
    );
    expect(() => toJapaneseDateString({})).toThrow(
      "input must be a Date object",
    );
  });
});
