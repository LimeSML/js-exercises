...
const productItem = document.querySelector('.product-list .product-item:first-child');
...
const productItemImages = document.querySelectorAll('.product-list .product-item img');
