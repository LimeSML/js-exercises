...
describe('instanceOf', () => {
    ...
    it('should throw error if object is null', () => {
        expect(() => instanceOf(null, A)).toThrow('object must be a non-null object');
    });

    it('should throw error if constructor is not a function', () => {
        const obj = new A();
        expect(() => instanceOf(obj, 123 as any)).toThrow('constructor must be a function');
        expect(() => instanceOf(obj, {} as any)).toThrow('constructor must be a function');
    });
