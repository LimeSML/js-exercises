...
describe('MagicWarrior class', () => {
    ...
    it('should throw error for negative atk', () => {
        expect(() => new MagicWarrior(-1, 1)).toThrow('atk must be a positive number');
    });

    it('should throw error for negative mgc', () => {
        expect(() => new MagicWarrior(1, -1)).toThrow('mgc must be a positive number');
    });
...
describe('WarriorFn function', () => {
    ...
    it('should throw error for negative atk', () => {
        expect(() => new (WarriorFn as any)(-1)).toThrow('atk must be a positive number');
    });
...
describe('MagicWarriorFn function', () => {
    ...
    it('should throw error for negative atk', () => {
        expect(() => new (MagicWarriorFn as any)(-1, 1)).toThrow('atk must be a positive number');
    });

    it('should throw error for negative mgc', () => {
        expect(() => new (MagicWarriorFn as any)(1, -1)).toThrow('mgc must be a positive number');
    });
