...
test.describe("Category select", () => {
  test("When initial value is 'all', all items are visible", async ({
    page,
  }) => {
  ...
  test("When 'food' is selected, only food items are visible", async ({
    page,
  }) => {
    await page.goto("/ch15.01-03/ex14/index.html");
  ...
  test("When 'stationery' is selected, only stationery items are visible", async ({
    page,
  }) => {
    await page.goto("/ch15.01-03/ex14/index.html");
